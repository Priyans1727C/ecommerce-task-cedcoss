...
const TieredPricingTable = ({ tiers, qty }) => (
  <div className="mt-8">
    ...
    <div className="mx-auto max-w-7xl px-4 py-10 md:px-8">
      ...
      <div className="grid gap-10 lg:grid-cols-2">
        ...
        <div>
          ...
          <TieredPricingTable tiers={product.tiers} qty={qty} />
